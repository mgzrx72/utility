...
public class AudioManeger : SingletonMonoBehaviour<AudioManeger>
{
    ...
    [SerializeField, Header("同時にならせるSE数")]
    private int MaxSE;
    [NonSerialized]
    ...
    private void SerchSE()
    {
        ...
        foreach (AudioClip se in Resources.LoadAll<AudioClip>("SE"))
        {
            string n = se.name;

            this.SeAudioClipDict.Add(n.Replace(" (UnityEngine.AudioClip",""), se);
        }
    }
    ...
    private void SearchBGM()
    {
        ...
        foreach (AudioClip bgm in Resources.LoadAll<AudioClip>("BGM"))
        {
